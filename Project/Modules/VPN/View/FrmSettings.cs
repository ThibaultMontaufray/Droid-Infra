...
namespace Droid_Infra
{
    ...
    /// </summary>
    public partial class ViewVPNSettings : UserControlCustom
    {
        [CLSCompliant(false)]
        [DllImport("user32")]
        ...
        private void RefreshServiceFields()
        {
            ...
            if (Helper.ServiceKeyExists())
            {
                ...
                {
                    lblServiceEnabled.Text = ProgramVPN.res.GetString("DIALOG_Enabled");
                    llWhy.Visible = false;
                }
                else
                {
                    m_error = ProgramVPN.res.GetString("BOX_Service_Same_Path");
                    lblServiceEnabled.Text = ProgramVPN.res.GetString("DIALOG_Disabled");
                    llWhy.Visible = true;
                }
            ...
            {
                m_error = ProgramVPN.res.GetString("BOX_Service_Not_Installed");
                lblServiceEnabled.Text = ProgramVPN.res.GetString("DIALOG_Disabled");
                llWhy.Visible = true;
            }
        }
        ...
        private void btnBrowseOVPNFile_Click(object sender, EventArgs e)
        {
            ...
            ofd.Title = ProgramVPN.res.GetString("DIALOG_Title_Open_OpenVPN");
            ofd.FileName = txtOVPNFile.Text;
            ofd.Filter = ProgramVPN.res.GetString("DIALOG_Filter_Application") +
                " (*.exe)|*.exe|" +
                ProgramVPN.res.GetString("DIALOG_Filter_Allfiles") +
                " (*.*)|*.*";
        ...
        private void WarnServiceChange(string oldBin, string p)
        {
            ...
            {
                RTLMessageBox.Show(ProgramVPN.res.GetString("BOX_UpdateService"),
        ...
        private void btnBrowseOVPNDir_Click(object sender, EventArgs e)
        {
            ...
            fbd.Description = ProgramVPN.res.GetString("DIALOG_Title_Folder");
        ...
        {
            RTLMessageBox.Show(this,
                ProgramVPN.res.GetString("BOX_Service_How_Change"),
                MessageBoxIcon.Information);
        }
