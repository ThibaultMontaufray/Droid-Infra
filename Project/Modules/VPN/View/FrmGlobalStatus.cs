...
namespace Droid_Infra
{
    ...
    /// </summary>
    public partial class ViewVPNGlobalStatus : UserControlCustom
    {
        ...
        public ViewVPNGlobalStatus(string[] commands)
        {
            InitializeComponent();
            ...
            if (checkupdate)
            {
                ...
                if (u.checkUpdate())
                {
                    niIcon.ShowBalloonTip(5000,
                        ProgramVPN.res.GetString("QUICKINFO_Update"),
                        ProgramVPN.res.GetString("QUICKINFO_Update_More"),
                        ToolTipIcon.Info);
                }
            }
        ...
        public void ShowSettings(bool detect)
        {
            ...
            if (runningConnections != "")
            {
                if (RTLMessageBox.Show(this,
                                        ProgramVPN.res.GetString("BOX_Settings_Close") + "\r\n" + runningConnections,
            ...
            ViewVPNSettings m_settingsDialog = new ViewVPNSettings();
            if (detect)
        ...
        public void SetTrayIconAndPopupText() {
            ...
            foreach (VPNConfig conf in m_configs)
            {
                ...
                switch (conf.VPNConnection.State.CreateSnapshot().ConnectionState)
                {
                    ...
                    case VPNConnectionState.Initializing:
                        niIconText += Shorten(conf.Name, 13) + ": " + ProgramVPN.res.GetString("STATE_Connecting")
                            + Environment.NewLine;
                        w++;
                        break;
                }
            ...
            if (niIconText.Length == 0 )
                niIconText = ProgramVPN.res.GetString("STATE_Disconnected");
