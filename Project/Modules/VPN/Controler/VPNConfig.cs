...
namespace Droid_Infra
{
    ...
    public class VPNConfig : IDisposable
    {
        ...
        /// </summary>
        private ViewVPNStatus m_status;

        /// <summary>
        /// holds a parent for the menu items<br />
        /// this is needed for invokes
        /// </summary>
        private ViewVPNGlobalStatus m_parent;
        ...
        private ViewVPNPasswd m_frmpw;

        private ViewVPNAuthentication m_frmlpw;

        private ViewVPNSelectPKCS11Key m_frmkey;
        ...
        static public VPNConfig CreateServiceConnection(string file,
            int dbglevel, bool smartCardSupport, ViewVPNGlobalStatus parent)
        {
        ...
        static public VPNConfig CreateUserspaceConnection(string bin,
            string file, int dbglevel, bool smartCardSupport, ViewVPNGlobalStatus parent)
        {
            VPNConfig vc = new VPNConfig();
            vc.m_file = file;
            vc.m_bin = bin;
        ...
        private VPNConfig()
        {
            ...
            m_status = new ViewVPNStatus(this);
        ...
        public void ShowErrors()
        {
            RTLMessageBox.Show(m_parent,
                ProgramVPN.res.GetString("BOX_Error_Information") +
        ...
        public void Connect()
        {
            ...
            catch (InvalidOperationException e)
            {
                 ...
                 */
                RTLMessageBox.Show(m_parent,
                    ProgramVPN.res.GetString("BOX_Error_Connect") +
        ...
        private void p_Exited(object sender, EventArgs e)
        {
            ...
            if (wasConnected && m_error_message == null)
                if (RTLMessageBox.Show(m_parent,
                    ProgramVPN.res.GetString("BOX_Reconnect"),
        ...
        {
            m_frmlpw = new ViewVPNAuthentication();
            string[] loginfo = null;
        ...
        private void m_vpn_needCardID(object sender, NeedCardIdEventArgs e)
        {
            ...
            {
                if (RTLMessageBox.Show(m_parent,
                    ProgramVPN.res.GetString("BOX_NoKey"),
            ...
            {
                // request key
                m_frmkey = new ViewVPNSelectPKCS11Key();
