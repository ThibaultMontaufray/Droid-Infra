...
[module: SuppressMessage("Microsoft.Naming",
    ...
    Scope = "namespace", Target = "Droid_Infra",
    MessageId = "VPN")]
namespace Droid_Infra
{
    ...
    static class ProgramVPN
    {
        ...
        public static ResourceManager res = new ResourceManager(
            "Droid_Infra.lang.strings",
            System.Reflection.Assembly.GetExecutingAssembly());

        private static ViewVPNGlobalStatus m_mainform;
        ...
        static void ProgramVPNInit(string[] args)
        {
            try
            {
