...
namespace Droid.Infra
{
    ...
    public class GitHubAdapter : InfraAdapter
    {
        #region Attribute
        ...
        {
            _techno = TECHNO.GITHUB;
            _type = AdapterType.GitHubAdapter;
        }
        public GitHubAdapter(InterfaceInfra intInfra)
        {
            _techno = TECHNO.GITHUB;
            _parent = intInfra;
            _type = AdapterType.GitHubAdapter;
        ...
        public IReadOnlyList<Repository> GetUserRepo()
        {
            ...
            {
                Log.Write("[ ERR 0000 ] Error getting user repository : " + exp.Message);
            }
            return null;
        }
        ...
        public List<Repository> GetRepos(string filter)
        {
            ...
            {
                Log.Write("[ ERR 0001 ] Error getting user repositories : " + exp.Message);
            }
            return repos;
        }
        public Repository GetRepo(string repoName)
        {
            ...
            {
                Log.Write("[ ERR 0002 ] Error getting user particular repository : " + exp.Message);
            }
            return null;
        }
