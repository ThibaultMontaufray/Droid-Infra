...
namespace Droid.Infra
{
    ...
    public class VPNConfig : IDisposable
    {
        ...
        /// </summary>
        private UserControlCustom m_parent;
        ...
        /// <seealso cref="init" />
        static public VPNConfig CreateServiceConnection(string file, int dbglevel, bool smartCardSupport, UserControlCustom parent)
        {
