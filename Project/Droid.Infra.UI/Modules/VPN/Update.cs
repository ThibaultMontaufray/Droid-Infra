...
namespace Droid.Infra.UI
{
    ...
    class Update
    {
        ...
        public void refresh(bool silence)
        {
            ...
            {
                if(!silence)
                RTLMessageBox.Show(m_parent, ProgramVPN.res.GetString(
        ...
        public string getUpdateUrl()
        {
            ...
            catch (NullReferenceException)
            {
                RTLMessageBox.Show(m_parent,
                    ProgramVPN.res.GetString("BOX_UpdateMissing"),
                    MessageBoxIcon.Error);
                return null;
            }
        ...
        public string getDownloadFileUrl()
        {
            ...
            {
                MessageBox.Show(ProgramVPN.res.GetString("BOX_UpdateMissing"),
