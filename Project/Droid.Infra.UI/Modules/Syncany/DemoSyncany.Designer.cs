namespace Droid.Infra.UI
{
    partial class DemoSyncany
    {
        ...
        {
            Droid.Infra.SyncanyAdapter interface_syncany1 = new Droid.Infra.SyncanyAdapter();
            ...
            this.cloudView1 = new Droid.Infra.CloudRepositories(_intSyn, _workingDirectory);
            this.SuspendLayout();
            // 
            // cloudView1
            // 
