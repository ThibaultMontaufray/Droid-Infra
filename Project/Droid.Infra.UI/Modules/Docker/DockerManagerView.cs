    ...
    public partial class DockerManagerView : UserControl
    {
        ...
        private void RefreshMachineDetails(Machine machine)
        {
            ...
            if (machine != null)
            {
                ...
                _adapter.Engine.Machines.Where(m => m.Name == machine?.Name).First()?.RefreshData();
        ...
        {
            if (listViewMachine.SelectedItems.Count == 1 && _adapter.Engine.Machines != null)
            {
                string machineName = listViewMachine.SelectedItems[0].Text;
                List<Machine> tab = _adapter.Engine.Machines.Where(m => m.Name.Equals(machineName)).ToList();
        ...
        private void buttonStart_Click(object sender, System.EventArgs e)
        {
            ...
            {
                Cursor = Cursors.WaitCursor;
                _adapter.Engine.Machines.Where(m => m.Name == textBoxMachineName.Text).First()?.Start();
                RefreshAllScreen();
                Cursor = Cursors.Arrow;
            }
        }
        private void buttonStop_Click(object sender, System.EventArgs e)
        {
            ...
            {
                Cursor = Cursors.WaitCursor;
                _adapter.Engine.Machines.Where(m => m.Name == textBoxMachineName.Text).First()?.Stop();
                RefreshAllScreen();
                Cursor = Cursors.Arrow;
            }
        }
        private void buttonDelete_Click(object sender, System.EventArgs e)
        {
            ...
            {
                Cursor = Cursors.WaitCursor;
                _adapter.Engine.Machines.Where(m => m.Name == textBoxMachineName.Text).First()?.Delete();
                RefreshAllScreen();
                Cursor = Cursors.Arrow;
            }
        }
        private void buttonCreate_Click(object sender, System.EventArgs e)
        {
            ...
            {
                // Add parameters of machine
                Cursor = Cursors.WaitCursor;

                Machine dockerMachine = new Machine();
                dockerMachine.Name = textBoxMachineName.Text;
